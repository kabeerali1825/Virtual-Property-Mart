...
def submitSignInForm():
    if request.method == "POST":
        ...
        user=[email,password]
        db=DB("localhost","root","123456","ecommerce")
        found=db.login(user)
        if found:
            session['email']=email
            return render_template("Home.html")
...
def submitAddPlaceForm():
    if request.method == "POST":
        ...
        file_path = 'C:\\Users\\shehr\\OneDrive\\Documents\\Project\\sem proj updated\\static\\images\\' + image.filename
...
@app.route('/carsdatatable')
def datatable():
    return render_template('carsdatatable.html')
...
def carsdata():
    ...
    if found:
        ...
        return render_template("carsdatatable.html", cars=cars)
    else :
        return render_template("carsdatatable.html", message="No car found")
    
@app.route('/placesdatatable')
def datatableplace():
    return render_template('placesdatatable.html')
@app.route('/placesdata', methods=["GET"])
def placesdata():
    ...
    if found:
        ...
        return render_template("placesdatatable.html", places=places)
    else :
        return render_template("placesdatatable.html", message="No Place found")
